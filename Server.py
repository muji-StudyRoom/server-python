...
def on_join_room(data):
    ...
    emit("chatting", f'새로운유저 {display_name} 님이 참가하셨습니다. ', broadcast=True, include_self=True, room=room_id)
...
def on_disconnect():
    ...
    emit("chatting", f' 유저 {display_name} 님이 나가셨습니다. ', broadcast=True, include_self=True, room=room_id)
